...
local Window = redzlib:MakeWindow({
  Title = "<font color='rgb(255,0,0)'>Tung tung ac wỷ hub</font>",
  SubTitle = "<font color='rgb(255,0,0)'>Blox Fruit</font>",
  SaveFolder = "AURAmain.lua"
})

Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://137859155367423", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(0, 5) },
})
local Tabs = {
    Info = Window:MakeTab({ Title = "Info And Status", Icon = "info" }),
    Main = Window:MakeTab({ Title = "Farming", Icon = "home" }),
    Settings = Window:MakeTab({ Title = "Setting Farming", Icon = "pen" }),
    Fish = Window:MakeTab({ Title = "Fishing", Icon = "apple pen" }),
    Quests = Window:MakeTab({ Title = "Stack Farm", Icon = "eraser" }),
    SeaEvent = Window:MakeTab({ Title = "Sea Events", Icon = "saubay" }),
    Mirage = Window:MakeTab({ Title = "Mirage", Icon = "mountain" }),
    Race = Window:MakeTab({ Title = "Upgrade Race", Icon = "sixseven" }),
    ...
    Travel = Window:MakeTab({ Title = "Teleport", Icon = "threesix" }),
    Shop = Window:MakeTab({ Title = "Shopping", Icon = "shop" }),
    Misc = Window:MakeTab({ Title = "Miscellaneous", Icon = "johncena" })
}

Tabs.Info:AddSection("Information")
    Tabs.Info:AddParagraph({
    Title = "TDZ Info",
    Content = "Developer: Floppa3667Owner: Real_TDZ"
})

    Tabs.Info:AddDiscordInvite({
    Title = "Our YouTube Channel",
    Description = "your mom fat",
    Logo = "rbxassetid://137859155367423",
    Invite = "https://www.youtube.com/@aovuathoi",
})
    Tabs.Info:AddDiscordInvite({
    Title = "Discord",
    Description = "Join Discord to receive notifications about script updates and more.",
    Logo = "rbxassetid://137859155367423",
    Invite = "https://discord.gg/coconcac",
})
...
AttackDropdown = Tabs.Main:AddDropdown({
    ...
    Options = {"Normal Attack","Fast Attack","Super Fast Attack","TDZ Attack"},
    Default = "Fast Attack",
    Callback = function(Value)
